        ...
        val restDocsResponse =
            response()
                .responseBodyFieldWithResult(
                    ...
                    fieldWithPath("result.records[].totalTime").description("총 이동 시간 밀리초 단위"),
                    ...
                    fieldWithPath("result.records[].runningPoints[].pace").description("페이스 밀리초 단위"),
                    ...
                    ).description("러닝 포인트 기록 당시 총 러닝 시간 밀리초 단위"),
                    fieldWithPath(
